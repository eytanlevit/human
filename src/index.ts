...
<body>
  <div class="container">
    ...
    <p class="description">
      human is a skill that lets AI agents ask humans for help. Agents often get stuck on stupid things a human can catch in 2 minutes — UI glitches, login flows, "does this look right?". Putting a human in the loop lets coding agents run productively for longer.
    </p>
