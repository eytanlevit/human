...
async function waitForResponse(requestId, maxWaitMs = 300000) {
...
server.tool("ask", "Ask a human a question and wait for their response. Use when you need human judgment, verification, or are stuck on something.", {
...
server.tool("verify", "Ask a human to verify that actual results match expected results. Use for output verification and QA.", {
...
server.tool("request_testing", "Request a human tester to functionally test something you built. Provide what to test, a link, and expected behavior.", {
